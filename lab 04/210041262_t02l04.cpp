...
public:
    static int totalStuedents;
   Student(string _first_name, string _last_name,int _id, int _birth_year, string _course, int _marks)
    {
    ...
    void printTranscript(){
        ...
        cout<<"Total Number Of Students "<<totalStuedents<<endl;
    }
  ~Student(){
    totalStuedents--;
    cout<<"The object is Destroyed"<<endl;
    cout<<"the number of total students is now  "<<totalStuedents<<endl;    
  }

};

int Student::totalStuedents=0;
...
int main(void)
{
    Student student1("Sakib", "Ahmed",210041262, 2001, "CSE", 90);
    Student::totalStuedents;
